<template>
  <div id="page-editor" class="min-h-screen bg-gray-100 p-4 flex flex-col">
    <div class="bg-white shadow-md rounded-lg p-6 flex flex-col flex-grow w-full">
      ...
      <div id="editor" class="flex-grow flex space-x-4 w-full">
        <div id="image-viewer" class="flex-1 bg-gray-200 rounded-lg overflow-hidden">
        ...
        <div id="text-editor" class="flex-1">
...
const getTextOfImage = async (imageName: string) => {
  try {
    ...
    isLoading.value = true  
    isLoadingText = true; // Début du chargement du texte
